...
for filename in args.files:
    ...
    if args.analytical:
        ...
        bls_eff = nbls*np.sqrt(((ngps**2-ngps)/2.)/ngps**2)
        ...
        pk_noise = 2*scalar*fr_correct*( (tsys)**2 / (inttime*pol*real*bls_eff*cnt*nmodes) ) #this 3-sigma curve should line up with pI
