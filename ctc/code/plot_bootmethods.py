...
# Plot
plt.plot(boot_bl['kpl'], n.abs(boot_bl['pIn_old'])+boot_bl['pIn_err_old']*2, color='black', linewidth=2, label='Bootstrap baselines only')
plt.plot(boot_time['kpl'], n.abs(boot_time['pIn_old'])+boot_time['pIn_err_old']*2, color='0.5', linewidth=2, label='Bootstrap baselines and times')
